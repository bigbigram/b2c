    ...
    public function getStores(Request $request)
    {
        $data = DB::table('store')
            ->select(
                ...
                'store.uid as uid',
                'store.name as name',
                'store.mobile as mobile',
                'store.lat as lat',
                'store.lng as lng',
                'store.verified as verified',
                'store.address as address',
                'store.descriptions as descriptions',
                'store.images as images',
                'store.cover as cover',
                'store.commission as commission',
                'store.open_time as open_time',
                'store.close_time as close_time',
                'store.isClosed as isClosed',
                'store.certificate_url as certificate_url',
                'store.certificate_type as certificate_type',
                'store.rating as rating',
                'store.total_rating as total_rating',
                'store.cid as cid',
                'store.zipcode as zipcode',
                'store.extra_field as extra_field',
