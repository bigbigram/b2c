...
class DriverRequestController extends Controller
{
    ...
    public function getNewRequest()
    {
        $data = DB::table('driver_request')
            ->select(
                'driver_request.id as id',
                'driver_request.address as address',
                'driver_request.cover as cover',
                'driver_request.city as city',
                'driver_request.gender as gender',
                'driver_request.first_name as first_name',
                'driver_request.last_name as last_name',
                'driver_request.mobile as mobile',
                'driver_request.country_code as country_code',
