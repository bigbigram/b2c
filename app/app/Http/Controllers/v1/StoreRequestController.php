    ...
    public function getNewRequest()
    {
        $data = DB::table('store_request')
            ->select(
                ...
                'store_request.address as address',
                'store_request.name as name',
                'store_request.cover as cover',
                'store_request.cid as cid',
                'store_request.open_time as open_time',
                'store_request.close_time as close_time',
                'store_request.first_name as first_name',
                'store_request.last_name as last_name',
                'store_request.mobile as mobile',
                'store_request.country_code as country_code',
